    ...
    <v-row justify="center" class="my-15">
      <v-col cols="11" sm="9" md="6">
        <v-card light class="calculator-card card-wrap d-flex flex-column justify-center align-center">
          <img src="@/assets/img/icon-twd.svg" width="60px" class="mb-5">
          <h2 :class="`primary_${$route.params.token}--text`">{{ $t('swapCalculateTitle', {token1: 'EGT', token2: 'TWD'}) }}</h2>
            ...
            <v-col cols="12">
              <v-form ref="form" lazy-validation class="d-flex flex-column justify-center align-center">
                ...
                <div class="d-flex flex-column align-center">
                  ...
                  <h2 :class="`primary_${$route.params.token}--text`">{{ twdResult || '--'}} {{ $t('dollar') }}</h2>
                </div>
              </v-form>
            </v-col>
          </v-row>
